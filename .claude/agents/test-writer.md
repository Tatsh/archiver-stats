...
You write comprehensive pytest test suites for archiver-stats. Follow all conventions in
...
def test_my_command_success(runner: CliRunner, mocker: MockerFixture) -> None:
    mock_func = mocker.patch('archiver_stats.commands.module.some_function')
